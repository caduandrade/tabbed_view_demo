...
import 'classic_theme_example.dart';

class ClassicThemePage extends DemoFluPage with MixinReloadExample {
  ...
  ValueNotifier<Color?> borderColor = ValueNotifier(null);
  ...
  void buildSections(BuildContext context, PageSections sections) {
    ...
    sections.widget((context) => Wrap(
            ...
            children: [
              ...
              ColorChooser(title: 'BorderColor', color: borderColor),
              DoubleChooser(
                  title: 'TabRadius', value: tabRadius, values: [5, 10, 15])
            ]));

    sections.widget((context) => ClassicThemeExample(
    ...
    sections.code(
        'lib/pages/theme/default_themes/classic_theme/classic_theme_example.dart',
        title: 'Code');
  }
}
